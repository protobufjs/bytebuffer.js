...
this.offset=0;this.markedOffset=-1;this.limit=a;this.littleEndian="undefined"!==typeof b?!!b:!1;this.noAssert=!!c}function t(a,b){var c=b,e,d,f,g,l,n;e=a.view.getUint8(b++);if(0!==(e&128))if(192===(e&224))d=a.view.getUint8(b++),e=(e&31)<<6|d&63;else if(224===(e&240))d=a.view.getUint8(b++),f=a.view.getUint8(b++),e=(e&15)<<12|(d&63)<<6|f&63;else if(240===(e&248))d=a.view.getUint8(b++),f=a.view.getUint8(b++),g=a.view.getUint8(b++),e=(e&7)<<18|(d&63)<<12|(f&63)<<6|g&63;else if(248===(e&252))d=a.view.getUint8(b++),
f=a.view.getUint8(b++),g=a.view.getUint8(b++),l=a.view.getUint8(b++),e=(e&3)<<24|(d&63)<<18|(f&63)<<12|(g&63)<<6|l&63;else if(252===(e&254))d=a.view.getUint8(b++),f=a.view.getUint8(b++),g=a.view.getUint8(b++),l=a.view.getUint8(b++),n=a.view.getUint8(b++),e=(e&1)<<30|(d&63)<<24|(f&63)<<18|(g&63)<<12|(l&63)<<6|n&63;else throw new RangeError("Illegal code point at offset "+b+": 0x"+e.toString(16));return{codePoint:e,length:b-c}}function u(a,b,c){var e=c;if(0>a)throw new RangeError("Illegal code point: -0x"+
(-a).toString(16));if(128>a)b.view.setUint8(c++,a&127);else if(2048>a)b.view.setUint8(c++,a>>6&31|192),b.view.setUint8(c++,a&63|128);else if(65536>a)b.view.setUint8(c++,a>>12&15|224),b.view.setUint8(c++,a>>6&63|128),b.view.setUint8(c++,a&63|128);else if(2097152>a)b.view.setUint8(c++,a>>18&7|240),b.view.setUint8(c++,a>>12&63|128),b.view.setUint8(c++,a>>6&63|128),b.view.setUint8(c++,a&63|128);else if(67108864>a)b.view.setUint8(c++,a>>24&3|248),b.view.setUint8(c++,a>>18&63|128),b.view.setUint8(c++,a>>
12&63|128),b.view.setUint8(c++,a>>6&63|128),b.view.setUint8(c++,a&63|128);else if(2147483648>a)b.view.setUint8(c++,a>>30&1|252),b.view.setUint8(c++,a>>24&63|128),b.view.setUint8(c++,a>>18&63|128),b.view.setUint8(c++,a>>12&63|128),b.view.setUint8(c++,a>>6&63|128),b.view.setUint8(c++,a&63|128);else throw new RangeError("Illegal code point: 0x"+a.toString(16));return c-e}function s(a){if(0>a)throw new RangeError("Illegal code point: -0x"+(-a).toString(16));if(128>a)return 1;if(2048>a)return 2;if(65536>
a)return 3;if(2097152>a)return 4;if(67108864>a)return 5;if(2147483648>a)return 6;throw new RangeError("Illegal code point: 0x"+a.toString(16));}function v(a){for(var b=0,c,e=0;b<a.length;)e+=s(c=a.b(b)),b+=65535>c?1:2;return e}d.VERSION="3.0.0-pre";d.LITTLE_ENDIAN=!0;d.BIG_ENDIAN=!1;d.DEFAULT_CAPACITY=16;d.DEFAULT_ENDIAN=d.BIG_ENDIAN;d.DEFAULT_NOASSERT=!1;d.Long=k||null;var r=new ArrayBuffer(0);d.allocate=function(a,b,c){return new d(a,b,c)};d.concat=function(a,b,c,e){if("boolean"===typeof b||"string"!==
typeof b)e=c,c=b,b=void 0;for(var h=0,f=0,g=a.length,l;f<g;++f)d.isByteBuffer(a[f])||(a[f]=d.wrap(a[f],b)),l=a[f].limit-a[f].offset,0<l&&(h+=l);if(0===h)return new d(0,c,e);b=new d(h,c,e);e=new Uint8Array(b.buffer);for(f=0;f<g;)c=a[f++],l=c.limit-c.offset,0>=l||(e.set((new Uint8Array(c.buffer)).subarray(c.offset,c.limit),b.offset),b.offset+=l);b.limit=b.offset;b.offset=0;return b};d.isByteBuffer=function(a){return a&&a instanceof d};d.type=function(){return ArrayBuffer};d.wrap=function(a,b,c,e){"string"!==
typeof b&&(e=c,c=b,b=void 0);if("string"===typeof a)switch("undefined"===typeof b&&(b="utf8"),b){case "base64":return d.fromBase64(a,c);case "hex":return d.fromHex(a,c);case "binary":return d.fromBinary(a,c);case "utf8":return d.fromUTF8(a,c);case "debug":return d.fromDebug(a,c);default:throw new TypeError("Unsupported encoding: "+b);}if(null===a||"object"!==typeof a)throw new TypeError("Illegal buffer: null or non-object");if(d.isByteBuffer(a))return b=d.prototype.clone.call(a),b.markedOffset=-1,
b;if(a instanceof Uint8Array)b=new d(0,c,e),0<a.length&&(b.buffer=a.buffer,b.offset=a.byteOffset,b.limit=a.byteOffset+a.length,b.view=0<a.length?new DataView(a.buffer):null);else if(a instanceof ArrayBuffer)b=new d(0,c,e),0<a.byteLength&&(b.buffer=a,b.offset=0,b.limit=a.byteLength,b.view=0<a.byteLength?new DataView(a):null);else throw new TypeError("Illegal buffer");return b};d.prototype.writeInt8=function(a,b){var c="undefined"===typeof b;c&&(b=this.offset);if(!this.noAssert){if("number"!==typeof a||
0!==a%1)throw new TypeError("Illegal value: "+a+" (not an integer)");a|=0;if("number"!==typeof b||0!==b%1)throw new TypeError("Illegal offset: "+b+" (not an integer)");b>>>=0;if(0>b||b+0>this.buffer.byteLength)throw new RangeError("Illegal offset: 0 <= "+b+" (+0) <= "+this.buffer.byteLength);}b+=1;var e=this.buffer.byteLength;b>e&&this.resize((e*=2)>b?e:b);this.view.setInt8(b-1,a);c&&(this.offset+=1);return this};d.prototype.writeByte=d.prototype.writeInt8;d.prototype.readInt8=function(a){var b="undefined"===
typeof a;b&&(a=this.offset);if(!this.noAssert){if("number"!==typeof a||0!==a%1)throw new TypeError("Illegal offset: "+a+" (not an integer)");a>>>=0;if(0>a||a+1>this.buffer.byteLength)throw new RangeError("Illegal offset: 0 <= "+a+" (+1) <= "+this.buffer.byteLength);}a=this.view.getInt8(a);b&&(this.offset+=1);return a};d.prototype.readByte=d.prototype.readInt8;d.prototype.writeUint8=function(a,b){var c="undefined"===typeof b;c&&(b=this.offset);if(!this.noAssert){if("number"!==typeof a||0!==a%1)throw new TypeError("Illegal value: "+
a+" (not an integer)");a>>>=0;if("number"!==typeof b||0!==b%1)throw new TypeError("Illegal offset: "+b+" (not an integer)");b>>>=0;if(0>b||b+0>this.buffer.byteLength)throw new RangeError("Illegal offset: 0 <= "+b+" (+0) <= "+this.buffer.byteLength);}b+=1;var e=this.buffer.byteLength;b>e&&this.resize((e*=2)>b?e:b);this.view.setUint8(b-1,a);c&&(this.offset+=1);return this};d.prototype.readUint8=function(a){var b="undefined"===typeof a;b&&(a=this.offset);if(!this.noAssert){if("number"!==typeof a||0!==
a%1)throw new TypeError("Illegal offset: "+a+" (not an integer)");a>>>=0;if(0>a||a+1>this.buffer.byteLength)throw new RangeError("Illegal offset: 0 <= "+a+" (+1) <= "+this.buffer.byteLength);}a=this.view.getUint8(a);b&&(this.offset+=1);return a};d.prototype.writeInt16=function(a,b){var c="undefined"===typeof b;c&&(b=this.offset);if(!this.noAssert){if("number"!==typeof a||0!==a%1)throw new TypeError("Illegal value: "+a+" (not an integer)");a|=0;if("number"!==typeof b||0!==b%1)throw new TypeError("Illegal offset: "+
...
a+" <= "+b+" <= "+this.buffer.byteLength);}if(a===b)return"";for(var c,e,d,f,g,l,n="";a<b;)c=this.view.getUint8(a++),e=(f=a<b)?this.view.getUint8(a++):0,d=(g=a<b)?this.view.getUint8(a++):0,l=c>>2,c=(c&3)<<4|e>>4,e=(e&15)<<2|d>>6,d&=63,g||(d=64,f||(e=64)),n+=m.charAt(l)+m.charAt(c)+m.charAt(e)+m.charAt(d);return n};d.fromBase64=function(a,b,c){if(!c){if("string"!==typeof a)throw new TypeError("Illegal str: Not a string");if(0!==a.length%4)throw new TypeError("Illegal str: Length not a multiple of 4");
}var e=a.length,h=0,f;for(f=a.length-1;0<=f;--f)if("="===a.charAt(f))h++;else break;if(2<h)throw new TypeError("Illegal str: Suffix is too large");if(0===e)return new d(0,b,c);var g,l,n,k=new d(e/4*3-h,b,c);for(b=f=0;f<e;){h=m.indexOf(a.charAt(f++));g=f<e?m.indexOf(a.charAt(f++)):0;l=f<e?m.indexOf(a.charAt(f++)):0;n=f<e?m.indexOf(a.charAt(f++)):0;if(!c&&(0>h||0>g||0>l||0>n))throw new TypeError("Illegal str: Contains non-base64 characters");k.view.setUint8(b++,h<<2|g>>4);64!==l&&(k.view.setUint8(b++,
g<<4&240|l>>2,b),64!==n&&k.view.setUint8(b++,l<<6&192|n))}k.limit=b;return k};d.btoa=function(a){return d.fromBinary(a).toBase64()};d.atob=function(a){return d.fromBase64(a).toBinary()};d.prototype.toBinary=function(a,b){a="undefined"===typeof a?this.offset:a;b="undefined"===typeof b?this.limit:b;if(!this.noAssert){if("number"!==typeof a||0!==a%1)throw new TypeError("Illegal begin: Not an integer");a>>>=0;if("number"!==typeof b||0!==b%1)throw new TypeError("Illegal end: Not an integer");b>>>=0;if(0>
...
"'":a||0!==b&&b!==c?" ":"")}if(a&&" "!==d){for(;51>d.length;)d+=" ";g+=d+f+"\n"}return a?g:d};d.fromDebug=function(a,b,c){var e=a.length;b=new d((e+1)/3|0,b,c);for(var h=0,f=0,g,l=!1,k=!1,q=!1,m=!1,p=!1;h<e;){switch(g=a.charAt(h++)){case "!":if(!c){if(k||q||m){p=!0;break}k=q=m=!0}b.offset=b.markedOffset=b.limit=f;l=!1;break;case "|":if(!c){if(k||m){p=!0;break}k=m=!0}b.offset=b.limit=f;l=!1;break;case "[":if(!c){if(k||q){p=!0;break}k=q=!0}b.offset=b.markedOffset=f;l=!1;break;case "<":if(!c){if(k){p=
!0;break}k=!0}b.offset=f;l=!1;break;case "]":if(!c){if(m||q){p=!0;break}m=q=!0}b.limit=b.markedOffset=f;l=!1;break;case ">":if(!c){if(m){p=!0;break}m=!0}b.limit=f;l=!1;break;case "'":if(!c){if(q){p=!0;break}q=!0}b.markedOffset=f;l=!1;break;case " ":l=!1;break;default:if(!c&&l){p=!0;break}g=parseInt(g+a.charAt(h++),16);if(!c&&(isNaN(g)||0>g||255<g))throw new TypeError("Illegal str: Not a debug encoded string");b.view.setUint8(f++,g);l=!0}if(p)throw new TypeError("Illegal str: Invalid symbol at "+h);
...
2){h=parseInt(a.substring(f,f+2),16);if(!c&&(!isFinite(h)||0>h||255<h))throw new TypeError("Illegal str: Contains non-hex characters");b.view.setUint8(g++,h)}b.limit=g;return b};String.a||function(){function a(){var a=[],b,g,l=-1,k=arguments.length;if(!k)return"";for(var m="";++l<k;){g=Number(arguments[l]);if(!isFinite(g)||0>g||1114111<g||d(g)!=g)throw RangeError("Invalid code point: "+g);65535>=g?a.push(g):(g-=65536,b=(g>>10)+55296,g=g%1024+56320,a.push(b,g));if(l+1==k||16384<a.length)m+=c.apply(null,
a),a.length=0}return m}var b=function(){try{var a={},b=Object.defineProperty,c=b(a,a,a)&&b}catch(d){}return c}(),c=String.fromCharCode,d=Math.floor;b?b(String,"fromCodePoint",{value:a,configurable:!0,writable:!0}):String.fromCodePoint=a}();String.prototype.b||function(){function a(a){if(null==this)throw TypeError();var c=String(this),d=c.length,h=a?Number(a):0;h!=h&&(h=0);if(!(0>h||h>=d))return a=c.charCodeAt(h),55296<=a&&56319>=a&&d>h+1&&(c=c.charCodeAt(h+1),56320<=c&&57343>=c)?1024*(a-55296)+c-
...
a+" <= "+b+" <= "+this.buffer.byteLength);}for(var c=[],d;a<b;)d=t(this,a),c.push(d.codePoint),a+=d.length;if(!this.noAssert&&a!==b)throw new RangeError("Illegal range: Truncated data");return String.a.apply(String,c)};d.fromUTF8=function(a,b,c){if(!c&&"string"!==typeof a)throw new TypeError("Illegal str: Not a string");b=new d(v(a),b,c);for(var e=c=0,h=a.length;c<h;++c)e+=u(a.b(c),b,e);b.limit=e;return b};return d}"undefined"!=typeof module&&module.exports?module.exports=r(require("long")):"undefined"!==
