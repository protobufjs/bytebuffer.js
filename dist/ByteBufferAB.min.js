...
this.buffer.byteLength);}if(a===b)return"";for(var c,e,d,f,g,l,k="";a<b;)c=this.view.getUint8(a++),e=(f=a<b)?this.view.getUint8(a++):0,d=(g=a<b)?this.view.getUint8(a++):0,l=c>>2,c=(c&3)<<4|e>>4,e=(e&15)<<2|d>>6,d&=63,g||(d=64,f||(e=64)),k+=m.charAt(l)+m.charAt(c)+m.charAt(e)+m.charAt(d);return k};d.fromBase64=function(a,b,c){if(!c){if("string"!==typeof a)throw TypeError("Illegal str: Not a string");if(0!==a.length%4)throw TypeError("Illegal str: Length not a multiple of 4");}var e=a.length,h=0,f;
for(f=a.length-1;0<=f;--f)if("="===a.charAt(f))h++;else break;if(2<h)throw TypeError("Illegal str: Suffix is too large");if(0===e)return new d(0,b,c);var g,l,k,n=new d(e/4*3-h,b,c);for(b=f=0;f<e;){h=m.indexOf(a.charAt(f++));g=f<e?m.indexOf(a.charAt(f++)):0;l=f<e?m.indexOf(a.charAt(f++)):0;k=f<e?m.indexOf(a.charAt(f++)):0;if(!c&&(0>h||0>g||0>l||0>k))throw TypeError("Illegal str: Contains non-base64 characters");n.view.setUint8(b++,h<<2|g>>4);64!==l&&(n.view.setUint8(b++,g<<4&240|l>>2,b),64!==k&&n.view.setUint8(b++,
l<<6&192|k))}n.limit=b;return n};d.btoa=function(a){return d.fromBinary(a).toBase64()};d.atob=function(a){return d.fromBase64(a).toBinary()};d.prototype.toBinary=function(a,b){a="undefined"===typeof a?this.offset:a;b="undefined"===typeof b?this.limit:b;if(!this.noAssert){if("number"!==typeof a||0!==a%1)throw new TypeError("Illegal begin: Not an integer");a>>>=0;if("number"!==typeof b||0!==b%1)throw new TypeError("Illegal end: Not an integer");b>>>=0;if(0>a||a>b||b>this.buffer.byteLength)throw new RangeError("Illegal range: 0 <= "+
...
b.view.setUint8(g++,h)}b.limit=g;return b};String.fromCodePoint||function(){function a(){var a=[],b,d,k=-1,m=arguments.length;if(!m)return"";for(var n="";++k<m;){d=Number(arguments[k]);if(!isFinite(d)||0>d||1114111<d||e(d)!=d)throw RangeError("Invalid code point: "+d);65535>=d?a.push(d):(d-=65536,b=(d>>10)+55296,d=d%1024+56320,a.push(b,d));if(k+1==m||16384<a.length)n+=c.apply(null,a),a.length=0}return n}var b=function(){try{var a={},b=Object.defineProperty,c=b(a,a,a)&&b}catch(e){}return c}(),c=String.fromCharCode,
e=Math.floor;b?b(String,"fromCodePoint",{value:a,configurable:!0,writable:!0}):String.fromCodePoint=a}();String.prototype.codePointAt||function(){function a(a){if(null==this)throw TypeError();var c=String(this),e=c.length,d=a?Number(a):0;d!=d&&(d=0);if(!(0>d||d>=e))return a=c.charCodeAt(d),55296<=a&&56319>=a&&e>d+1&&(c=c.charCodeAt(d+1),56320<=c&&57343>=c)?1024*(a-55296)+c-56320+65536:a}Object.defineProperty?Object.defineProperty(String.prototype,"codePointAt",{value:a,configurable:!0,writable:!0}):
String.prototype.codePointAt=a}();d.prototype.toUTF8=function(a,b){"undefined"===typeof a&&(a=this.offset);"undefined"===typeof b&&(b=this.limit);if(!this.noAssert){if("number"!==typeof a||0!==a%1)throw new TypeError("Illegal begin: Not an integer");a>>>=0;if("number"!==typeof b||0!==b%1)throw new TypeError("Illegal end: Not an integer");b>>>=0;if(0>a||a>b||b>this.buffer.byteLength)throw new RangeError("Illegal range: 0 <= "+a+" <= "+b+" <= "+this.buffer.byteLength);}for(var c=[],d;a<b;)d=s(this,
a),c.push(d.codePoint),a+=d.length;if(!this.noAssert&&a!==b)throw new RangeError("Illegal range: Truncated data");return String.fromCodePoint.apply(String,c)};d.fromUTF8=function(a,b,c){if(!c&&"string"!==typeof a)throw new TypeError("Illegal str: Not a string");b=new d(t(a),b,c);for(var e=0,h=0,f=a.length;e<f;++e)c=a.charCodeAt(e),55296<=c&&57343>=c&&(c=a.codePointAt(e),65535<c&&e++),h+=u(c,b,h);b.limit=h;return b};return d}"undefined"!=typeof module&&module.exports?module.exports=q(require("long")):
"undefined"!==typeof define&&define.amd?define("ByteBuffer",["Math/Long"],function(k){return q(k)}):(r.dcodeIO||(r.dcodeIO={}),r.dcodeIO.ByteBuffer=q(r.dcodeIO.Long))})(this);
