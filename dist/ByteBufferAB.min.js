...
t(a);b+=d+1;e=this.buffer.byteLength;b>e&&this.resize((e*=2)>b?e:b);b-=d+1;var g,d=a.length;for(e=0;e<d;e++)g=a.charCodeAt(e),55296<=g&&57343>=g&&(g=a.codePointAt(e),65535<g&&e++),b+=u(g,this,b);this.view.setUint8(b++,0);return c?(this.offset=b,this):b-f};d.prototype.readCString=function(a){var b="undefined"===typeof a;b&&(a=this.offset);if(!this.noAssert){if("number"!==typeof a||0!==a%1)throw new TypeError("Illegal offset: "+a+" (not an integer)");a>>>=0;if(0>a||a+1>this.buffer.byteLength)throw new RangeError("Illegal offset: 0 <= "+
...
2|d>>6,d&=63,g||(d=64,f||(e=64)),k+=m.charAt(l)+m.charAt(c)+m.charAt(e)+m.charAt(d);return k};d.fromBase64=function(a,b,c){if(!c){if("string"!==typeof a)throw TypeError("Illegal str: Not a string");if(0!==a.length%4)throw TypeError("Illegal str: Length not a multiple of 4");}var e=a.length,h=0,f;for(f=a.length-1;0<=f;--f)if("="===a.charAt(f))h++;else break;if(2<h)throw TypeError("Illegal str: Suffix is too large");if(0===e)return new d(0,b,c);var g,l,k,n=new d(e/4*3-h,b,c);for(b=f=0;f<e;){h=m.indexOf(a.charAt(f++));
g=f<e?m.indexOf(a.charAt(f++)):0;l=f<e?m.indexOf(a.charAt(f++)):0;k=f<e?m.indexOf(a.charAt(f++)):0;if(!c&&(0>h||0>g||0>l||0>k))throw TypeError("Illegal str: Contains non-base64 characters");n.view.setUint8(b++,h<<2|g>>4);64!==l&&(n.view.setUint8(b++,g<<4&240|l>>2,b),64!==k&&n.view.setUint8(b++,l<<6&192|k))}n.limit=b;return n};d.btoa=function(a){return d.fromBinary(a).toBase64()};d.atob=function(a){return d.fromBase64(a).toBinary()};d.prototype.toBinary=function(a,b){a="undefined"===typeof a?this.offset:
...
if(!m)return"";for(var n="";++k<m;){d=Number(arguments[k]);if(!isFinite(d)||0>d||1114111<d||e(d)!=d)throw RangeError("Invalid code point: "+d);65535>=d?a.push(d):(d-=65536,b=(d>>10)+55296,d=d%1024+56320,a.push(b,d));if(k+1==m||16384<a.length)n+=c.apply(null,a),a.length=0}return n}var b=function(){try{var a={},b=Object.defineProperty,c=b(a,a,a)&&b}catch(e){}return c}(),c=String.fromCharCode,e=Math.floor;b?b(String,"fromCodePoint",{value:a,configurable:!0,writable:!0}):String.fromCodePoint=a}();String.prototype.codePointAt||
function(){function a(a){if(null==this)throw TypeError();var c=String(this),e=c.length,d=a?Number(a):0;d!=d&&(d=0);if(!(0>d||d>=e))return a=c.charCodeAt(d),55296<=a&&56319>=a&&e>d+1&&(c=c.charCodeAt(d+1),56320<=c&&57343>=c)?1024*(a-55296)+c-56320+65536:a}Object.defineProperty?Object.defineProperty(String.prototype,"codePointAt",{value:a,configurable:!0,writable:!0}):String.prototype.codePointAt=a}();d.prototype.toUTF8=function(a,b){"undefined"===typeof a&&(a=this.offset);"undefined"===typeof b&&(b=
