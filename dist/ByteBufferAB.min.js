...
b+": "+e);return{codePoint:e,length:b-c}}function s(a){if(0>a)throw RangeError("Illegal code point: "+a);if(128>a)return 1;if(2048>a)return 2;if(65536>a)return 3;if(1114112>a)return 4;throw RangeError("Illegal code point: "+a);}function u(a){for(var b,c=0,e=0;e<a.length;e++)b=a.charCodeAt(e),55296<=b&&57343>=b&&(b=a.b(e),65535<b&&e++),c+=s(b);return c}function v(a,b,c){var e=c;if(0>a)throw RangeError("Illegal code point: "+a);if(128>a)b.view.setUint8(c++,a&127);else if(2048>a)b.view.setUint8(c++,
...
d.METRICS_CHARS="c";d.METRICS_BYTES="b";d.prototype.writeUTF8String=function(a,b){var c="undefined"===typeof b;c&&(b=this.offset);if(!this.noAssert){if("number"!==typeof b||0!==b%1)throw new TypeError("Illegal offset: "+b+" (not an integer)");b>>>=0;if(0>b||b+0>this.buffer.byteLength)throw new RangeError("Illegal offset: 0 <= "+b+" (+0) <= "+this.buffer.byteLength);}var e,d=b;e=u(a);b+=e;var f=this.buffer.byteLength;b>f&&this.resize((f*=2)>b?f:b);b-=e;for(f=0;f<a.length;f++)e=a.charCodeAt(f),55296<=
e&&57343>=e&&(e=a.b(f),65535<e&&f++),b+=v(e,this,b);return c?(this.offset=b,this):b-d};d.prototype.writeString=d.prototype.writeUTF8String;d.calculateUTF8Chars=function(a){for(var b=0,c,e=0;e<a.length;e++)c=a.charCodeAt(e),55296<=c&&57343>=c&&(c=a.b(e),65535<c&&e++),b++;return b};d.calculateUTF8Bytes=u;d.prototype.readUTF8String=function(a,b,c){"number"===typeof b&&(c=b,b=void 0);var e="undefined"===typeof c;e&&(c=this.offset);"undefined"===typeof b&&(b=d.METRICS_CHARS);if(!this.noAssert){if("number"!==
typeof a||0!==a%1)throw new TypeError("Illegal length: "+a+" (not an integer)");a|=0;if("number"!==typeof c||0!==c%1)throw new TypeError("Illegal offset: "+c+" (not an integer)");c>>>=0;if(0>c||c+0>this.buffer.byteLength)throw new RangeError("Illegal offset: 0 <= "+c+" (+0) <= "+this.buffer.byteLength);}var h=0,f=c,g;if(b===d.METRICS_CHARS){for(b=[];h<a;)g=t(this,c),c+=g.length,b.push(g.codePoint),++h;return e?(this.offset=c,String.a.apply(String,b)):{string:String.a.apply(String,b),length:c-f}}if(b===
...
a+" <= "+b+" <= "+this.buffer.byteLength);}if(a===b)return"";for(var c,e,d,f,g,l,q="";a<b;)c=this.view.getUint8(a++),e=(f=a<b)?this.view.getUint8(a++):0,d=(g=a<b)?this.view.getUint8(a++):0,l=c>>2,c=(c&3)<<4|e>>4,e=(e&15)<<2|d>>6,d&=63,g||(d=64,f||(e=64)),q+=m.charAt(l)+m.charAt(c)+m.charAt(e)+m.charAt(d);return q};d.fromBase64=function(a,b,c){if(!c){if("string"!==typeof a)throw TypeError("Illegal str: Not a string");if(0!==a.length%4)throw TypeError("Illegal str: Length not a multiple of 4");}var e=
a.length,h=0,f;for(f=a.length-1;0<=f;--f)if("="===a.charAt(f))h++;else break;if(2<h)throw TypeError("Illegal str: Suffix is too large");if(0===e)return new d(0,b,c);var g,l,q,k=new d(e/4*3-h,b,c);for(b=f=0;f<e;){h=m.indexOf(a.charAt(f++));g=f<e?m.indexOf(a.charAt(f++)):0;l=f<e?m.indexOf(a.charAt(f++)):0;q=f<e?m.indexOf(a.charAt(f++)):0;if(!c&&(0>h||0>g||0>l||0>q))throw TypeError("Illegal str: Contains non-base64 characters");k.view.setUint8(b++,h<<2|g>>4);64!==l&&(k.view.setUint8(b++,g<<4&240|l>>
2,b),64!==q&&k.view.setUint8(b++,l<<6&192|q))}k.limit=b;return k};d.btoa=function(a){return d.fromBinary(a).toBase64()};d.atob=function(a){return d.fromBase64(a).toBinary()};d.prototype.toBinary=function(a,b){a="undefined"===typeof a?this.offset:a;b="undefined"===typeof b?this.limit:b;if(!this.noAssert){if("number"!==typeof a||0!==a%1)throw new TypeError("Illegal begin: Not an integer");a>>>=0;if("number"!==typeof b||0!==b%1)throw new TypeError("Illegal end: Not an integer");b>>>=0;if(0>a||a>b||b>
...
2){h=parseInt(a.substring(f,f+2),16);if(!c&&(!isFinite(h)||0>h||255<h))throw new TypeError("Illegal str: Contains non-hex characters");b.view.setUint8(g++,h)}b.limit=g;return b};String.a||function(){function a(){var a=[],b,d,k=-1,m=arguments.length;if(!m)return"";for(var n="";++k<m;){d=Number(arguments[k]);if(!isFinite(d)||0>d||1114111<d||e(d)!=d)throw RangeError("Invalid code point: "+d);65535>=d?a.push(d):(d-=65536,b=(d>>10)+55296,d=d%1024+56320,a.push(b,d));if(k+1==m||16384<a.length)n+=c.apply(null,
