...
a!==b)throw new RangeError("Illegal range: Truncated data");return String.fromCodePoint.apply(String,c)};d.fromUTF8=function(a,b,c){if(!c&&"string"!==typeof a)throw new TypeError("Illegal str: Not a string");b=new d(t(a),b,c);for(var e=c=0,h=a.length;c<h;++c)e+=u(a.codePointAt(c),b,e);b.limit=e;return b};return d}"undefined"!=typeof module&&module.exports?module.exports=q(require("long")):"undefined"!==typeof define&&define.amd?define("ByteBuffer",["Math/Long"],function(k){return q(k)}):(r.dcodeIO||
(r.dcodeIO={}),r.dcodeIO.ByteBuffer=q(r.dcodeIO.Long))})(this);
