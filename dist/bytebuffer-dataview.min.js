...
null}}function s(){var a=[],b=[];return function(){if(0===arguments.length)return b.join("")+v.apply(String,a);1024<a.length+arguments.length&&(b.push(v.apply(String,a)),a.length=0);Array.prototype.push.apply(a,arguments)}}f.VERSION="5.0.0";f.LITTLE_ENDIAN=!0;f.BIG_ENDIAN=!1;f.DEFAULT_CAPACITY=16;f.DEFAULT_ENDIAN=f.BIG_ENDIAN;f.DEFAULT_NOASSERT=!1;f.Long=k||null;var d=f.prototype;Object.defineProperty(d,"__isByteBuffer__",{value:!0,enumerable:!1,configurable:!1});var u=new ArrayBuffer(0),v=String.fromCharCode;
