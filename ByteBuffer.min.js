...
null}catch(n){}c.VERSION="2.0.0-pre";c.DEFAULT_CAPACITY=16;c.LITTLE_ENDIAN=!0;c.BIG_ENDIAN=!1;c.Long=k;c.allocate=function(a,b){return new c(a,b)};c.wrap=function(a,b){if("string"===typeof a)return(new c).writeUTF8String(a).flip();var d;if(m&&m.isBuffer(a)){d=(new Uint8Array(a)).buffer;if(d===a){d=a;for(var f=new ArrayBuffer(d.length),e=new Uint8Array(f),g=0;g<d.length;++g)e[g]=d[g];d=f}a=d}if(null===a||"object"!==typeof a)throw Error("Cannot wrap null or non-object");if(a instanceof c)return a.clone();
a.array?a=a.array:a.buffer&&(a=a.buffer);if(!(a instanceof ArrayBuffer))throw Error("Cannot wrap buffer of type "+typeof a+", "+a.constructor.name);d=new c(0,b,!0);d.array=a;d.view=new DataView(d.array);d.offset=0;d.length=a.byteLength;return d};c.prototype.LE=function(){this.littleEndian=!0;return this};c.prototype.BE=function(){this.littleEndian=!1;return this};c.prototype.resize=function(a){if(1>a)return!1;null==this.array&&(this.array=new ArrayBuffer(a),this.view=new DataView(this.array));if(this.array.byteLength<
...
8);this.view.setFloat64(b,a,this.littleEndian);return this};c.prototype.readFloat64=function(a){a="undefined"!==typeof a?a:(this.offset+=8)-8;if(null==this.array||a+8>this.array.byteLength)throw Error("Cannot read float64 from "+this+" at "+a+": Capacity overflow");return this.view.getFloat64(a,this.littleEndian)};c.prototype.writeDouble=c.prototype.writeFloat64;c.prototype.readDouble=c.prototype.readFloat64;c.prototype.writeInt64=function(a,b){if(!k)throw Error("Long support is not available: See https://github.com/dcodeIO/ByteBuffer.js#on-long-int64-support for details");
b="undefined"!==typeof b?b:(this.offset+=8)-8;"object"===typeof a&&a instanceof k||(a=k.fromNumber(a,!1));this.ensureCapacity(b+8);this.littleEndian?(this.view.setInt32(b,a.getLowBits(),!0),this.view.setInt32(b+4,a.getHighBits(),!0)):(this.view.setInt32(b,a.getHighBits(),!1),this.view.setInt32(b+4,a.getLowBits(),!1));return this};c.prototype.readInt64=function(a){if(!k)throw Error("Long support is not available: See https://github.com/dcodeIO/ByteBuffer.js#on-long-int64-support for details");a="undefined"!==
typeof a?a:(this.offset+=8)-8;if(null==this.array||a+8>this.array.byteLength)throw this.offset-=8,Error("Cannot read int64 from "+this+" at "+a+": Capacity overflow");return this.littleEndian?k.fromBits(this.view.getInt32(a,!0),this.view.getInt32(a+4,!0),!1):k.fromBits(this.view.getInt32(a+4,!1),this.view.getInt32(a,!1),!1)};c.prototype.writeUint64=function(a,b){if(!k)throw Error("Long support is not available: See https://github.com/dcodeIO/ByteBuffer.js#on-long-int64-support for details");b="undefined"!==
...
63)<<12|(e&63)<<6|g&63,b+=4;else if(248==(d&252))c=a.readUint8(b+1),e=a.readUint8(b+2),g=a.readUint8(b+3),k=a.readUint8(b+4),d=(d&3)<<24|(c&63)<<18|(e&63)<<12|(g&63)<<6|k&63,b+=5;else if(252==(d&254))c=a.readUint8(b+1),e=a.readUint8(b+2),g=a.readUint8(b+3),k=a.readUint8(b+4),h=a.readUint8(b+5),d=(d&1)<<30|(c&63)<<24|(e&63)<<18|(g&63)<<12|(k&63)<<6|h&63,b+=6;else throw Error("Cannot decode UTF8 character at offset "+b+": charCode (0x"+d.toString(16)+") is invalid");return{"char":d,length:b-m}};c.encodeUTF8Char=
