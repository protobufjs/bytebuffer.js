...
n.wrap=function(a,b){a.array?a=a.array:a.buffer&&(a=a.buffer);a instanceof ArrayBuffer||d("Cannot wrap buffer of type "+typeof a);var c=new n(0,b,j);c.array=a;c.view=new DataView(c.array);c.offset=0;c.length=a.byteLength;return c};n.prototype.resize=function(a){this.array==k&&0<a&&(this.array=new ArrayBuffer(a),this.view=new DataView(this.array));if(this.array.byteLength<a){var b=new Uint8Array(this.array);a=new ArrayBuffer(a);(new Uint8Array(a)).set(b);this.array=a;this.view=new DataView(a);return j}return!1};
...
n.prototype.readFloat64=function(a){a="undefined"!=typeof a?a:(this.offset+=8)-8;return this.view.getFloat64(a,this.littleEndian)};n.prototype.writeDouble=n.prototype.writeFloat64;n.prototype.readDouble=n.prototype.readFloat64;n.prototype.writeLong=n.prototype.writeFloat64;n.prototype.readLong=function(a){return Math.round(this.readFloat64(a))};n.b=function(a){m[0]=a;l.set(m);return l[0]};
n.prototype.writeVarint32=function(a,b){var c="undefined"==typeof b;b="undefined"!=typeof b?b:this.offset;this.ensureCapacity(b+n.calculateVarint32(a));var e=new Uint8Array(this.array),f=0;e[b]=a|128;128<=a?(e[b+1]=a>>7|128,16384<=a?(e[b+2]=a>>14|128,2097152<=a?(e[b+3]=a>>21|128,268435456<=a?(e[b+4]=a>>28&127,f=5):(e[b+3]&=127,f=4)):(e[b+2]&=127,f=3)):(e[b+1]&=127,f=2)):(e[b]&=127,f=1);return c?(this.offset+=f,this):f};
n.prototype.readVarint32=function(a){var b="undefined"==typeof a;a="undefined"!=typeof a?a:this.offset;var c=new Uint8Array(this.array),e=0,f=0,g;do e==n.a&&d("Cannot read Varint32 from "+this+"@"+a+": Number of bytes is larger than "+n.a),g=c[a+e],f|=(g&127)<<7*e,++e;while(g&128);4294967295<f&&d("Cannot read Varint32 from "+this+"@"+a+": Value ("+f+") is out of bounds");f=n.b(f);return b?(this.offset+=e,f):{value:f,length:e}};n.prototype.writeVarint=n.prototype.writeVarint32;
n.prototype.readVarint=n.prototype.readVarint32;n.calculateVarint32=function(a){return 128>a?1:16384>a?2:2097152>a?3:268435456>a?4:5};n.prototype.writeUTF8String=function(a,b){var c="undefined"==typeof b,e=b="undefined"!=typeof b?b:this.offset,f=0,g;for(g=0;g<a.length;g++)f+=n.calculateUTF8Char(a.charCodeAt(g));this.ensureCapacity(b+f);for(g=0;g<a.length;g++)b+=n.encodeUTF8Char(a.charCodeAt(g),this,b);return c?(this.offset=b,this):b-e};
...
n.prototype.readCString=function(a){var b="undefined"==typeof a;a="undefined"!=typeof a?a:this.offset;var c,e="",f=a;do c=n.decodeUTF8Char(this,a),a+=c.length,0!=c["char"]&&(e+=String.fromCharCode(c["char"]));while(0!=c["char"]);return b?(this.offset=a,e):{string:e,length:a-f}};n.prototype.writeJSON=function(a,b,c){c=c||JSON.stringify.bind(JSON);return this.writeLString(c(a),b)};
n.prototype.readJSON=function(a,b){b=b||JSON.parse.bind(JSON);var c=this.readLString(a);return"string"==typeof c?b(c):{data:b(c.string),length:c.length}};n.prototype.printDebug=function(){if("undefined"!=typeof console&&console.log){for(var a=this.toString()+"\n-------------------------------------------------------------------\n",b=this.toHex(16,j),c=this.toASCII(16,j),e=0;e<b.length;e++)a+=b[e]+"  "+c[e]+"\n";console.log(a)}};
...
n.calculateUTF8Char=function(a){0>a&&d("Cannot calculate length of UTF8 character: charCode ("+a+") is negative");if(128>a)return 1;if(2048>a)return 2;if(65536>a)return 3;if(2097152>a)return 4;if(67108864>a)return 5;if(2147483648>a)return 6;d("Cannot calculate length of UTF8 character: charCode (0x"+a.toString(16)+") is too large (>= 0x80000000)")};n.a=5;
"undefined"!=typeof module&&module.exports?module.exports=n:"undefined"!=typeof define&&define.amd?define([],function(){return n}):(this.dcodeIO||(this.dcodeIO={}),this.dcodeIO.ByteBuffer=n);
