...
"object"==typeof a&&a instanceof g||(a=g.fromNumber(a,p));var e=a.toInt()>>>0,f=a.shiftRightUnsigned(28).toInt()>>>0,k=a.shiftRightUnsigned(56).toInt()>>>0,q=c.calculateVarint64(a);this.ensureCapacity(b+q);var h=new Uint8Array(this.array);switch(q){case 10:h[b+9]=k>>>7|128;case 9:h[b+8]=k|128;case 8:h[b+7]=f>>>21|128;case 7:h[b+6]=f>>>14|128;case 6:h[b+5]=f>>>7|128;case 5:h[b+4]=f|128;case 4:h[b+3]=e>>>21|128;case 3:h[b+2]=e>>>14|128;case 2:h[b+1]=e>>>7|128;case 1:h[b+0]=e|128}h[b+q-1]&=127;return d?
(this.offset+=q,this):q};c.prototype.readVarint64=function(a){g||l(Error("Long support is not available: See https://github.com/dcodeIO/ByteBuffer.js#on-long-int64-support for details"));var b="undefined"==typeof a,d=a="undefined"!=typeof a?a:this.offset,c=new Uint8Array(this.array),f,k=0,q=0,h;h=c[a++];f=h&127;h&128&&(h=c[a++],f|=(h&127)<<7,h&128&&(h=c[a++],f|=(h&127)<<14,h&128&&(h=c[a++],f|=(h&127)<<21,h&128&&(h=c[a++],k=h&127,h&128&&(h=c[a++],k|=(h&127)<<7,h&128&&(h=c[a++],k|=(h&127)<<14,h&128&&
...
c.prototype.writeVarint32;c.prototype.readVarint=c.prototype.readVarint32;c.prototype.writeZigZagVarint=c.prototype.writeZigZagVarint32;c.prototype.readZigZagVarint=c.prototype.readZigZagVarint32;c.calculateVarint32=function(a){a>>>=0;return 128>a?1:16384>a?2:2097152>a?3:268435456>a?4:5};c.calculateVarint64=function(a){g||l(Error("Long support is not available: See https://github.com/dcodeIO/ByteBuffer.js#on-long-int64-support for details"));"object"==typeof a&&a instanceof g||(a=g.fromNumber(a,p));
var b=a.toInt()>>>0,d=a.shiftRightUnsigned(28).toInt()>>>0;a=a.shiftRightUnsigned(56).toInt()>>>0;return 0==a?0==d?16384>b?128>b?1:2:2097152>b?3:4:16384>d?128>d?5:6:2097152>d?7:8:128>a?9:10};c.zigZagEncode32=function(a){return((a|=0)<<1^a>>31)>>>0};c.zigZagDecode32=function(a){return a>>>1^-(a&1)|0};c.zigZagEncode64=function(a){g||l(Error("Long support is not available: See https://github.com/dcodeIO/ByteBuffer.js#on-long-int64-support for details"));"object"==typeof a&&a instanceof g?a.unsigned&&
(a=a.toSigned()):a=g.fromNumber(a,p);return a.shiftLeft(1).xor(a.shiftRight(63)).toUnsigned()};c.zigZagDecode64=function(a){g||l(Error("Long support is not available: See https://github.com/dcodeIO/ByteBuffer.js#on-long-int64-support for details"));"object"==typeof a&&a instanceof g?a.unsigned||(a=a.toUnsigned()):a=g.fromNumber(a,m);return a.shiftRightUnsigned(1).xor(a.and(g.ONE).toSigned().negate()).toSigned()};c.decodeUTF8Char=function(a,b){var d=a.readUint8(b),c,f,k,q,h,g=b;0==(d&128)?(c=d,b+=
1):192==(d&224)?(c=a.readUint8(b+1),c=(d&31)<<6|c&63,b+=2):224==(d&240)?(c=a.readUint8(b+1),f=a.readUint8(b+2),c=(d&15)<<12|(c&63)<<6|f&63,b+=3):240==(d&248)?(c=a.readUint8(b+1),f=a.readUint8(b+2),k=a.readUint8(b+3),c=(d&7)<<18|(c&63)<<12|(f&63)<<6|k&63,b+=4):248==(d&252)?(c=a.readUint8(b+1),f=a.readUint8(b+2),k=a.readUint8(b+3),q=a.readUint8(b+4),c=(d&3)<<24|(c&63)<<18|(f&63)<<12|(k&63)<<6|q&63,b+=5):252==(d&254)?(c=a.readUint8(b+1),f=a.readUint8(b+2),k=a.readUint8(b+3),q=a.readUint8(b+4),h=a.readUint8(b+
5),c=(d&1)<<30|(c&63)<<24|(f&63)<<18|(k&63)<<12|(q&63)<<6|h&63,b+=6):l(Error("Cannot decode UTF8 character at offset "+b+": charCode (0x"+d.toString(16)+") is invalid"));return{"char":c,length:b-g}};c.encodeUTF8Char=function(a,b,c){var e=c;0>a&&l(Error("Cannot encode UTF8 character: charCode ("+a+") is negative"));128>a?(b.writeUint8(a&127,c),c+=1):2048>a?(b.writeUint8(a>>6&31|192,c).writeUint8(a&63|128,c+1),c+=2):65536>a?(b.writeUint8(a>>12&15|224,c).writeUint8(a>>6&63|128,c+1).writeUint8(a&63|128,
c+2),c+=3):2097152>a?(b.writeUint8(a>>18&7|240,c).writeUint8(a>>12&63|128,c+1).writeUint8(a>>6&63|128,c+2).writeUint8(a&63|128,c+3),c+=4):67108864>a?(b.writeUint8(a>>24&3|248,c).writeUint8(a>>18&63|128,c+1).writeUint8(a>>12&63|128,c+2).writeUint8(a>>6&63|128,c+3).writeUint8(a&63|128,c+4),c+=5):2147483648>a?(b.writeUint8(a>>30&1|252,c).writeUint8(a>>24&63|128,c+1).writeUint8(a>>18&63|128,c+2).writeUint8(a>>12&63|128,c+3).writeUint8(a>>6&63|128,c+4).writeUint8(a&63|128,c+5),c+=6):l(Error("Cannot encode UTF8 character: charCode (0x"+
...
b){if(this.array==n)return"DESTROYED";b=!!b;a="undefined"!=typeof a?parseInt(a,10):16;1>a&&(a=16);for(var c="",e=[],f=new Uint8Array(this.array),c=0==this.offset&&0==this.length?c+"|":0==this.length?c+">":0==this.offset?c+"<":c+" ",k=0;k<this.array.byteLength;k++){0<k&&0==k%a&&(e.push(c),c=" ");var g=f[k],g=g.toString(16).toUpperCase();2>g.length&&(g="0"+g);c+=g;c=k+1==this.offset&&k+1==this.length?c+"|":k+1==this.offset?c+"<":k+1==this.length?c+">":c+" "}if(b)for(;c.length<3*a+1;)c+="   ";e.push(c);
return b?e:e.join("\n")};c.prototype.toASCII=function(a,b){if(this.array==n)return"";b=!!b;a="undefined"!=typeof a?parseInt(a,10):16;1>a&&(a=16);for(var c="",e=[],f=new Uint8Array(this.array),k=0;k<this.array.byteLength;k++){0<k&&0==k%a&&(e.push(c),c="");var g=f[k],g=32<g&&127>g?String.fromCharCode(g):".",c=c+g}e.push(c);return b?e:e.join("\n")+"\n"};c.prototype.toString=function(){return this.array==n?"ByteBuffer(DESTROYED)":"ByteBuffer(offset="+this.offset+",markedOffset="+this.markedOffset+",length="+
this.length+",capacity="+this.array.byteLength+")"};c.prototype.toArrayBuffer=function(a){var b=this.clone();b.offset>b.length&&b.flip();var c=p;if(0<b.offset||b.length<b.array.byteLength)b.compact(),c=m;return a&&!c?b.copy().array:b.array};c.prototype.toBuffer=function(){if(s){var a=this.offset,b=this.length;if(a>b)var c=a,a=b,b=c;c=new Uint8Array(this.array);return new s(c.subarray(a,b))}l(Error("Conversion to Buffer is available under node.js only"))};c.extend=function(a,b){"string"==typeof a&&
"function"==typeof b?c.prototype[a]=b:l(Error("Cannot extend prototype with "+a+"="+b+" (exptected string and function)"))};return c}"undefined"!=typeof module&&module.exports?module.exports=t(require("long"),require("buffer")):"undefined"!=typeof define&&define.amd?define("ByteBuffer",["Math/Long"],function(g){return t(g)}):(r.dcodeIO||(r.dcodeIO={}),r.dcodeIO.ByteBuffer=t(dcodeIO.Long))})(this);
