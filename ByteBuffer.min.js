...
")":"ByteBuffer(DESTROYED)")+"\n-------------------------------------------------------------------\n",c=this.toHex(16,m),e=this.toASCII(16,m),f=0;f<c.length;f++)b+=c[f]+"  "+e[f]+"\n";if(a===m)return b;"function"==typeof a?a(b):console.log(b)};c.prototype.toHex=function(a,b){if(this.array==n)return"DESTROYED";b=!!b;a="undefined"!=typeof a?parseInt(a,10):16;1>a&&(a=16);for(var c="",e=[],f=new Uint8Array(this.array),c=0==this.offset&&0==this.length?c+"|":0==this.length?c+">":0==this.offset?c+"<":c+
" ",g=0;g<this.array.byteLength;g++){0<g&&0==g%a&&(e.push(c),c=" ");var h=f[g],h=h.toString(16).toUpperCase();2>h.length&&(h="0"+h);c+=h;c=g+1==this.offset&&g+1==this.length?c+"|":g+1==this.offset?c+"<":g+1==this.length?c+">":c+" "}if(b)for(;c.length<3*a+1;)c+="   ";e.push(c);return b?e:e.join("\n")};c.prototype.toASCII=function(a,b){if(this.array==n)return"";b=!!b;a="undefined"!=typeof a?parseInt(a,10):16;1>a&&(a=16);for(var c="",e=[],f=new Uint8Array(this.array),g=0;g<this.array.byteLength;g++){0<
g&&0==g%a&&(e.push(c),c="");var h=f[g],h=32<h&&127>h?String.fromCharCode(h):".",c=c+h}e.push(c);return b?e:e.join("\n")+"\n"};c.prototype.toString=function(){return this.array==n?"ByteBuffer(DESTROYED)":"ByteBuffer(offset="+this.offset+",markedOffset="+this.markedOffset+",length="+this.length+",capacity="+this.array.byteLength+")"};c.prototype.toArrayBuffer=function(a){var b=this.clone();b.offset>b.length&&b.flip();var c=p;if(0<b.offset||b.length<b.array.byteLength)b.compact(),c=m;return a&&!c?b.copy().array:
...
typeof define&&define.amd?define("ByteBuffer",["Math/Long"],function(h){return t(h)}):(r.dcodeIO||(r.dcodeIO={}),r.dcodeIO.ByteBuffer=t(dcodeIO.Long))})(this);
