...
function(){try{require("buffer");var a=this.offset,b=this.length;if(a>b)var c=a,a=b,b=c;return new Buffer((new Uint8Array(this.array)).subarray(a,b))}catch(e){console.trace(e),l("ByteBuffer#toBuffer() is available with node.js only")}};c.extend=function(a,b){"string"==typeof a&&"function"==typeof b?c.prototype[a]=b:l(Error("Cannot extend prototype with "+a+"="+b+" (exptected string and function)"))};return c}"undefined"!=typeof module&&module.exports?module.exports=s(require("long")):"undefined"!=
