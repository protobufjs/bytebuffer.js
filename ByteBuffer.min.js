...
n.wrap=function(a,b){if("string"==typeof a)return(new n).writeUTF8String(a);a.array?a=a.array:a.buffer&&(a=a.buffer);a instanceof ArrayBuffer||d("Cannot wrap buffer of type "+typeof a);var c=new n(0,b,j);c.array=a;c.view=new DataView(c.array);c.offset=0;c.length=a.byteLength;return c};
...
n.calculateUTF8Char=function(a){0>a&&d("Cannot calculate length of UTF8 character: charCode ("+a+") is negative");if(128>a)return 1;if(2048>a)return 2;if(65536>a)return 3;if(2097152>a)return 4;if(67108864>a)return 5;if(2147483648>a)return 6;d("Cannot calculate length of UTF8 character: charCode (0x"+a.toString(16)+") is too large (>= 0x80000000)")};n.zigZagEncode32=function(a){a=parseInt(a,10);return 0<=a?2*a:2*-a-1};n.zigZagDecode32=function(a){a=parseInt(a,10);return 0==(a&1)?a/2:-(a+1)/2};
n.extend=function(a,b){"string"==typeof a&&"function"==typeof b?n.prototype[a]=b:d("Cannot extend prototype with "+a+"="+b+" (exptected string and function)")};"undefined"!=typeof module&&module.exports?module.exports=n:"undefined"!=typeof define&&define.amd?define("ByteBuffer",[],function(){return n}):(this.dcodeIO||(this.dcodeIO={}),this.dcodeIO.ByteBuffer=n);
